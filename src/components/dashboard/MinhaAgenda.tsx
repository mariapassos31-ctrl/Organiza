...
export default function MinhaAgenda() {
  ...
  const getNomeUsuario = (uid: string) => usuarios.find(u => u.uid === uid)?.nome || 'Desconhecido'
  ...
  const obterEscalasDoDia = (data: Date | null) => {
    if (!data) return []
    ...
    return doDia.sort((a, b) => Number(b.tipo === 'sobreaviso') - Number(a.tipo === 'sobreaviso'))
  }
