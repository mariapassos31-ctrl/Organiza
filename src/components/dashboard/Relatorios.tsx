...
import type { Escala, Troca, TecnicoResumo } from '../../types/dominio'
...
const STATUS_TROCA_LABEL: Record<string, string> = {
  pendente: 'Pendente',
  aceita: 'Aceita',
  recusada: 'Recusada',
  cancelada: 'Cancelada',
...
export default function Relatorios() {
  ...
  const getNomeTecnico = (uid: string) => tecnicos.find(t => t.id === uid)?.nome || 'Desconhecido'
